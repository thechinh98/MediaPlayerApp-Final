...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private void updatePlayingInfo(boolean restore, boolean startPlay) {
        ...
        if (startPlay) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    mMusicService.startForeground(MusicNotificationManager.Companion.getNOTIFICATION_ID(),
                ...
                public void run() {
                    ...
                    if (mMusicService.isRestoredFromPause()) {
                        ...
                        mMusicService.getMusicNotificationManager().getNotificationManager()
                                .notify(MusicNotificationManager.Companion.getNOTIFICATION_ID(),
    ...
    private void updatePlayingStatus() {
        final int drawable = mPlayerAdapter.getState() != PlaybackInfoListener.State.Companion.getPAUSED() ?
    ...
    class PlaybackListener extends PlaybackInfoListener {
        ...
        public void onStateChanged(@State int state) {
            ...
            updatePlayingStatus();
            if (mPlayerAdapter.getState() != State.Companion.getRESUMED() && mPlayerAdapter.getState() != State.Companion.getPAUSED()) {
